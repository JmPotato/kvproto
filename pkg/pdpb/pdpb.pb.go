...
type TokenBucketRequest struct {
	Header                      *RequestHeader `protobuf:"bytes,1,opt,name=header,proto3" json:"header,omitempty"`
	ConsumptionSinceLastRequest Consumption    `protobuf:"bytes,2,opt,name=consumption_since_last_request,json=consumptionSinceLastRequest,proto3" json:"consumption_since_last_request"`
	TenantId                    uint64         `protobuf:"varint,3,opt,name=tenant_id,json=tenantId,proto3" json:"tenant_id,omitempty"`
	InstanceFingerprint         string         `protobuf:"bytes,4,opt,name=instance_fingerprint,json=instanceFingerprint,proto3" json:"instance_fingerprint,omitempty"`
	RequestedRU                 float64        `protobuf:"fixed64,5,opt,name=requested_r_u,json=requestedRU,proto3" json:"requested_r_u,omitempty"`
	TargetRequestPeriodSeconds  uint64         `protobuf:"varint,6,opt,name=target_request_period_seconds,json=targetRequestPeriodSeconds,proto3" json:"target_request_period_seconds,omitempty"`
	XXX_NoUnkeyedLiteral        struct{}       `json:"-"`
	XXX_unrecognized            []byte         `json:"-"`
	XXX_sizecache               int32          `json:"-"`
}
...
func (m *TokenBucketRequest) GetHeader() *RequestHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *TokenBucketRequest) GetTenantId() uint64 {
	if m != nil {
		return m.TenantId
	}
	return 0
...
func (m *TokenBucketRequest) GetInstanceFingerprint() string {
	if m != nil {
		return m.InstanceFingerprint
	}
	return ""
}

func (m *TokenBucketRequest) GetRequestedRU() float64 {
	if m != nil {
		return m.RequestedRU
	}
	return 0
}

func (m *TokenBucketRequest) GetTargetRequestPeriodSeconds() uint64 {
	if m != nil {
		return m.TargetRequestPeriodSeconds
	}
	return 0
}
...
type TokenBucketResponse struct {
	...
	TrickleDurationSeconds int64           `protobuf:"varint,3,opt,name=trickle_duration_seconds,json=trickleDurationSeconds,proto3" json:"trickle_duration_seconds,omitempty"`
...
func (m *TokenBucketResponse) GetHeader() *ResponseHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *TokenBucketResponse) GetGrantedRU() float64 {
	if m != nil {
		return m.GrantedRU
	}
	return 0
...
func (m *TokenBucketResponse) GetTrickleDurationSeconds() int64 {
	if m != nil {
		return m.TrickleDurationSeconds
	}
	return 0
}

func (m *TokenBucketResponse) GetFallbackRate() float64 {
	if m != nil {
		return m.FallbackRate
	}
	return 0
}
...
type Consumption struct {
	...
	PodsCpuSeconds         float64  `protobuf:"fixed64,6,opt,name=pods_cpu_seconds,json=podsCpuSeconds,proto3" json:"pods_cpu_seconds,omitempty"`
	KvReadCpuMilliseconds  uint64   `protobuf:"varint,7,opt,name=kv_read_cpu_milliseconds,json=kvReadCpuMilliseconds,proto3" json:"kv_read_cpu_milliseconds,omitempty"`
	KvWriteCpuMilliseconds uint64   `protobuf:"varint,8,opt,name=kv_write_cpu_milliseconds,json=kvWriteCpuMilliseconds,proto3" json:"kv_write_cpu_milliseconds,omitempty"`
	XXX_NoUnkeyedLiteral   struct{} `json:"-"`
	XXX_unrecognized       []byte   `json:"-"`
	XXX_sizecache          int32    `json:"-"`
}
...
func (m *Consumption) GetRU() float64 {
	if m != nil {
		return m.RU
	}
	return 0
...
func (m *Consumption) GetReadRequests() uint64 {
	if m != nil {
...
func (m *Consumption) GetReadBytes() uint64 {
	if m != nil {
		return m.ReadBytes
	}
	return 0
...
func (m *Consumption) GetWriteRequests() uint64 {
	if m != nil {
...
func (m *Consumption) GetWriteBytes() uint64 {
	if m != nil {
		return m.WriteBytes
	}
	return 0
...
func (m *Consumption) GetPodsCpuSeconds() float64 {
	if m != nil {
		return m.PodsCpuSeconds
	}
	return 0
}

func (m *Consumption) GetKvReadCpuMilliseconds() uint64 {
	if m != nil {
		return m.KvReadCpuMilliseconds
	}
	return 0
}

func (m *Consumption) GetKvWriteCpuMilliseconds() uint64 {
	if m != nil {
		return m.KvWriteCpuMilliseconds
	}
	return 0
}
...
func init() {
	...
	proto.RegisterType((*TokenBucketRequest)(nil), "pdpb.TokenBucketRequest")
	proto.RegisterType((*TokenBucketResponse)(nil), "pdpb.TokenBucketResponse")
	proto.RegisterType((*Consumption)(nil), "pdpb.Consumption")
}
...
var fileDescriptor_78b27e6f04f44c6e = []byte{
	...
	,
}
...
func (c *pDClient) TokenBucket(ctx context.Context, in *TokenBucketRequest, opts ...grpc.CallOption) (*TokenBucketResponse, error) {
	out := new(TokenBucketResponse)
	err := c.cc.Invoke(ctx, "/pdpb.PD/TokenBucket", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedPDServer) TokenBucket(ctx context.Context, req *TokenBucketRequest) (*TokenBucketResponse, error) {
...
func _PD_TokenBucket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TokenBucketRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PDServer).TokenBucket(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pdpb.PD/TokenBucket",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PDServer).TokenBucket(ctx, req.(*TokenBucketRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _PD_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _PD_TokenBucket_Handler,
		},
	},
...
func (m *TokenBucketRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.TargetRequestPeriodSeconds != 0 {
		i = encodeVarintPdpb(dAtA, i, uint64(m.TargetRequestPeriodSeconds))
		i--
		dAtA[i] = 0x30
	}
	if m.RequestedRU != 0 {
	...
	if len(m.InstanceFingerprint) > 0 {
		i -= len(m.InstanceFingerprint)
		copy(dAtA[i:], m.InstanceFingerprint)
		i = encodeVarintPdpb(dAtA, i, uint64(len(m.InstanceFingerprint)))
		i--
		dAtA[i] = 0x22
	}
	if m.TenantId != 0 {
		i = encodeVarintPdpb(dAtA, i, uint64(m.TenantId))
		i--
		dAtA[i] = 0x18
	}
	{
...
func (m *TokenBucketResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.TrickleDurationSeconds != 0 {
		i = encodeVarintPdpb(dAtA, i, uint64(m.TrickleDurationSeconds))
		i--
		dAtA[i] = 0x18
	}
	if m.GrantedRU != 0 {
...
func (m *Consumption) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.KvWriteCpuMilliseconds != 0 {
		i = encodeVarintPdpb(dAtA, i, uint64(m.KvWriteCpuMilliseconds))
		i--
		dAtA[i] = 0x40
	}
	if m.KvReadCpuMilliseconds != 0 {
		i = encodeVarintPdpb(dAtA, i, uint64(m.KvReadCpuMilliseconds))
		i--
		dAtA[i] = 0x38
	}
	if m.PodsCpuSeconds != 0 {
		i -= 8
		encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.PodsCpuSeconds))))
		i--
		dAtA[i] = 0x31
	}
	if m.WriteBytes != 0 {
		i = encodeVarintPdpb(dAtA, i, uint64(m.WriteBytes))
		i--
		dAtA[i] = 0x28
	}
	if m.WriteRequests != 0 {
		i = encodeVarintPdpb(dAtA, i, uint64(m.WriteRequests))
		i--
		dAtA[i] = 0x20
	}
	if m.ReadBytes != 0 {
	...
	if m.ReadRequests != 0 {
		i = encodeVarintPdpb(dAtA, i, uint64(m.ReadRequests))
		i--
		dAtA[i] = 0x10
	}
	if m.RU != 0 {
...
func (m *TokenBucketRequest) Size() (n int) {
	...
	n += 1 + l + sovPdpb(uint64(l))
	if m.TenantId != 0 {
		n += 1 + sovPdpb(uint64(m.TenantId))
	}
	l = len(m.InstanceFingerprint)
	if l > 0 {
		n += 1 + l + sovPdpb(uint64(l))
	}
	if m.RequestedRU != 0 {
	...
	if m.TargetRequestPeriodSeconds != 0 {
		n += 1 + sovPdpb(uint64(m.TargetRequestPeriodSeconds))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *TokenBucketResponse) Size() (n int) {
	...
	if m.TrickleDurationSeconds != 0 {
		n += 1 + sovPdpb(uint64(m.TrickleDurationSeconds))
	}
	if m.FallbackRate != 0 {
		n += 9
	}
...
func (m *Consumption) Size() (n int) {
	...
	if m.ReadRequests != 0 {
		n += 1 + sovPdpb(uint64(m.ReadRequests))
	}
	if m.ReadBytes != 0 {
		n += 1 + sovPdpb(uint64(m.ReadBytes))
	}
	if m.WriteRequests != 0 {
		n += 1 + sovPdpb(uint64(m.WriteRequests))
	}
	if m.WriteBytes != 0 {
		n += 1 + sovPdpb(uint64(m.WriteBytes))
	}
	if m.PodsCpuSeconds != 0 {
		n += 9
	}
	if m.KvReadCpuMilliseconds != 0 {
		n += 1 + sovPdpb(uint64(m.KvReadCpuMilliseconds))
	}
	if m.KvWriteCpuMilliseconds != 0 {
		n += 1 + sovPdpb(uint64(m.KvWriteCpuMilliseconds))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *TokenBucketRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InstanceFingerprint", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.InstanceFingerprint = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 5:
			if wireType != 1 {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TargetRequestPeriodSeconds", wireType)
			}
			m.TargetRequestPeriodSeconds = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPdpb
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TargetRequestPeriodSeconds |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *TokenBucketResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TrickleDurationSeconds", wireType)
			}
			m.TrickleDurationSeconds = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPdpb
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TrickleDurationSeconds |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Consumption) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field PodsCpuSeconds", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.PodsCpuSeconds = float64(math.Float64frombits(v))
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field KvReadCpuMilliseconds", wireType)
			}
			m.KvReadCpuMilliseconds = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPdpb
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.KvReadCpuMilliseconds |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field KvWriteCpuMilliseconds", wireType)
			}
			m.KvWriteCpuMilliseconds = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPdpb
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.KvWriteCpuMilliseconds |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
